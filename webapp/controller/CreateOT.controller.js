	...
	return Controller.extend("OTApp.controller.CreateOT", {
		...
		addDates: function(oEvent) {
			...
			var OTemp = $(result.AllDates).filter(function(i, n) {
				return n.Mid === midSelect;
			});
			//	result.TempDates = OTemp
		...
		handleCalendarSelect: function(oEvent) {
			...
			for (var i = 0; i < aSelectedDates.length; i++) {
				var list = {
					"MilNo": midSelect,
					"Dates": aSelectedDates[i].getStartDate(),
					"Hrs": ""
				};
		...
		handleCloseButton: function(oEvent) {
			// var aSelectedDates = sap.ui.getCore().byId("calendar").getSelectedDates();

			// for (var i=0; i<result.Employee_dataSet.lenght; i++)
			// {
			// 	// this.getView().byId("days").setText(aSelectedDates.length);
			// }
